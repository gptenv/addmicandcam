...
function ApiDocsPage() {
    return (_jsx(Shell, { children: _jsxs("section", { className: "docs", children: [_jsx("h1", { children: "API Docs" }), _jsxs("p", { children: ["All endpoints return JSON shaped like ", _jsx("code", { children: "{ ok, action, data, error }" }), ". This is a public API; no authentication token is required."] }), _jsx("h2", { children: "Create Session" }), _jsx("pre", { children: `curl -s -X POST http://localhost:3000/api/sessions \\
